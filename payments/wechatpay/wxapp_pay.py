...
class WxPayConf_pub(object):
    ...
    APPID = settings.WECHAT_APP_PAY_INFO['basic_info']['APPID']
    # JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    APPSECRET = settings.WECHAT_APP_PAY_INFO['basic_info']['APPSECRET']
    # 受理商ID，身份标识
    MCHID = settings.WECHAT_APP_PAY_INFO['basic_info']['MCHID']
    # 商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    KEY = settings.WECHAT_APP_PAY_INFO['basic_info']['KEY']
    ACCESS_TOKEN = settings.WECHAT_APP_PAY_INFO['basic_info']['ACCESS_TOKEN']

    # 异步通知url，商户根据实际开发过程设定
    NOTIFY_URL = settings.WECHAT_APP_PAY_INFO['other_info']['NOTIFY_URL']
    # =======【证书路径设置】=====================================
    # 证书路径,注意应该填写绝对路径
    SSLCERT_PATH = ''
    SSLKEY_PATH = ''
